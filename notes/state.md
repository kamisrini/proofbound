...
**Exact next action:** commit this coherent Task 5 slice, regenerate the closure packet and census
against the committed checker, then run the Task 5 acceptance commands and bare `make check`. If
green, update the state to begin Task 6 (measurements and falsifier evaluation). Do not widen P6
scope.
